    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="number" name="no_telp" placeholder="Masukkan No Telepon" class="form-control" value="<?php echo $meledak['no_telp']; ?>">
            </div>
            <div class="form-group">
                <label>Masukan Alamat</label>
                <input type="text" name="alamat" placeholder="Masukkan Alamat Anda" class="form-control" value="<?php echo $meledak['alamat']; ?>">
            </div>
            <div class="form-group">
                <label>Masukan Email</label>
                <input type="text" name="email" placeholder="Masukkan Email Anda" class="form-control" value="<?php echo $meledak['email']; ?>" disabled>
            </div>

            <div class="form-group">
                <label>Password</label>
                <input type="text" name="password" placeholder="Masukkan Password Anda" class="form-control" value="<?php echo $meledak['password']; ?>" disabled>
            </div>

            <button type="submit" class="btn btn-success">GASS</button>
            <button type="reset" class="btn btn-warning">LOM</button>
            <a href="../user/index.php" class="btn btn-danger">KEMBALI</a>
